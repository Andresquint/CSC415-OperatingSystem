...
//delcare fucntions needed to be implemented in this file
...
int main() {
  ...
  char input_buf[MAX_BUFF_SIZE];
	char *myargv[MAX_BUFF_SIZE];
	int myargc;
	char *token;
  ...
  printf("Myshell> ");
  while(fgets(input_buf, MAX_BUFF_SIZE, stdin) != NULL) {
    //reset myargc
    myargc = 0;
